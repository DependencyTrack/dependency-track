...
public enum ConfigPropertyConstants {
    ...
    GENERAL_MANUFACTURER_NAME("general", "manufacturer.name", null, PropertyType.STRING, "Name of the organization that manufactures BOMs generated by Dependency-Track (CycloneDX 1.6+ exports only)", ConfigPropertyAccessMode.READ_WRITE),
    GENERAL_MANUFACTURER_URL("general", "manufacturer.url", null, PropertyType.URL, "URL of the organization that manufactures BOMs generated by Dependency-Track (CycloneDX 1.6+ exports only)", ConfigPropertyAccessMode.READ_WRITE),
    GENERAL_MANUFACTURER_CONTACT_NAME("general", "manufacturer.contact.name", null, PropertyType.STRING, "Name of the contact for the organization that manufactures BOMs generated by Dependency-Track (CycloneDX 1.6+ exports only)", ConfigPropertyAccessMode.READ_WRITE),
    GENERAL_MANUFACTURER_CONTACT_EMAIL("general", "manufacturer.contact.email", null, PropertyType.STRING, "Email address of the contact for the organization that manufactures BOMs generated by Dependency-Track (CycloneDX 1.6+ exports only)", ConfigPropertyAccessMode.READ_WRITE),
