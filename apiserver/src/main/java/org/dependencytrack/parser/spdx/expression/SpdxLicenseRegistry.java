...
final class SpdxLicenseRegistry {
    ...
    static final List<LicenseFamily> FAMILIES = List.of(
            ...
            LicenseFamily.of(
                    VersionGroup.of("AGPL-1.0", "AGPL-1.0-only"), VersionGroup.of("AGPL-3.0", "AGPL-3.0-only")),
            LicenseFamily.of(
                    VersionGroup.of("Apache-1.0"), VersionGroup.of("Apache-1.1"), VersionGroup.of("Apache-2.0")),
            LicenseFamily.of(
                    VersionGroup.of("APSL-1.0"),
                    VersionGroup.of("APSL-1.1"),
                    VersionGroup.of("APSL-1.2"),
                    VersionGroup.of("APSL-2.0")),
            LicenseFamily.of(VersionGroup.of("Artistic-1.0"), VersionGroup.of("Artistic-2.0")),
            LicenseFamily.of(VersionGroup.of("ASWF-Digital-Assets-1.0"), VersionGroup.of("ASWF-Digital-Assets-1.1")),
            LicenseFamily.of(VersionGroup.of("BitTorrent-1.0"), VersionGroup.of("BitTorrent-1.1")),
            LicenseFamily.of(
            ...
            LicenseFamily.of(VersionGroup.of("CDDL-1.0"), VersionGroup.of("CDDL-1.1")),
            LicenseFamily.of(
                    VersionGroup.of("CECILL-1.0"),
                    VersionGroup.of("CECILL-1.1"),
                    VersionGroup.of("CECILL-2.0"),
                    VersionGroup.of("CECILL-2.1")),
            LicenseFamily.of(VersionGroup.of("DRL-1.0"), VersionGroup.of("DRL-1.1")),
            LicenseFamily.of(VersionGroup.of("ECL-1.0"), VersionGroup.of("ECL-2.0")),
            LicenseFamily.of(VersionGroup.of("EFL-1.0"), VersionGroup.of("EFL-2.0")),
            LicenseFamily.of(VersionGroup.of("EPL-1.0"), VersionGroup.of("EPL-2.0")),
            LicenseFamily.of(VersionGroup.of("EUPL-1.0"), VersionGroup.of("EUPL-1.1"), VersionGroup.of("EUPL-1.2")),
            LicenseFamily.of(
            ...
            LicenseFamily.of(VersionGroup.of("HP-1986"), VersionGroup.of("HP-1989")),
            LicenseFamily.of(
                    VersionGroup.of("LGPL-2.0", "LGPL-2.0-only"),
                    VersionGroup.of("LGPL-2.1", "LGPL-2.1-only"),
                    VersionGroup.of("LGPL-3.0", "LGPL-3.0-only")),
            LicenseFamily.of(VersionGroup.of("LPL-1.0"), VersionGroup.of("LPL-1.02")),
            LicenseFamily.of(
            ...
            LicenseFamily.of(VersionGroup.of("MPL-1.0"), VersionGroup.of("MPL-1.1"), VersionGroup.of("MPL-2.0")),
            LicenseFamily.of(VersionGroup.of("NPL-1.0"), VersionGroup.of("NPL-1.1")),
            LicenseFamily.of(VersionGroup.of("OFL-1.0"), VersionGroup.of("OFL-1.1")),
            LicenseFamily.of(
            ...
            LicenseFamily.of(VersionGroup.of("PHP-3.0"), VersionGroup.of("PHP-3.01")),
            LicenseFamily.of(VersionGroup.of("RPL-1.1"), VersionGroup.of("RPL-1.5")),
            LicenseFamily.of(VersionGroup.of("SGI-B-1.0"), VersionGroup.of("SGI-B-1.1"), VersionGroup.of("SGI-B-2.0")),
            LicenseFamily.of(VersionGroup.of("YPL-1.0"), VersionGroup.of("YPL-1.1")),
            LicenseFamily.of(VersionGroup.of("ZPL-1.1"), VersionGroup.of("ZPL-2.0"), VersionGroup.of("ZPL-2.1")),
            LicenseFamily.of(VersionGroup.of("Zimbra-1.3"), VersionGroup.of("Zimbra-1.4")),
            LicenseFamily.of(VersionGroup.of("bzip2-1.0.5"), VersionGroup.of("bzip2-1.0.6")));
