...
public record LicenseResponse(
        ...
        @Schema(description = "Full license text") @Nullable String licenseText,

        @Schema(description = "Standard license template used to derive the license text") @Nullable
        String standardLicenseTemplate,

        @Schema(description = "Standard license header typically added to the top of source code") @Nullable
        String standardLicenseHeader,

        @Schema(description = "Comments about the license") @Nullable
        ...
        @Schema(description = "Additional URLs with information about the license") @Nullable
        List<String> seeAlso,
    ...
    public static LicenseResponse of(License license) {
        ...
        final List<LicenseGroup> groups =
                jdoGroups != null ? jdoGroups.stream().map(LicenseGroup::of).toList() : List.of();
        ...
        return new LicenseResponse(
                ...
                license.getSeeAlso() != null ? List.of(license.getSeeAlso()) : null,
                groups,
                license.getUuid());
    }
}
