...
public record RepositoryResponse(
        ...
        @Schema(
                description = "Order in which the repository is queried during version resolution",
                requiredMode = Schema.RequiredMode.REQUIRED)
        int resolutionOrder,
        ...
        @Schema(description = "Username to authenticate with") @Nullable
        String username,

        @Schema(description = "Name of the secret holding the password or token") @Nullable
        String password,
