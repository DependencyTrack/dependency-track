...
public class CweConditionTest extends PersistenceCapableTest {
    private static Object[] parameters() {
        return new Object[] {
            new Object[] {
                ...
                PolicyCondition.Operator.CONTAINS_ANY,
                "CWE-123",
                123,
                0,
                true,
            ...
            new Object[] {
                ...
                PolicyCondition.Operator.CONTAINS_ALL,
                "CWE-123, CWE-786",
                123,
                786,
                true,
    ...
    public void testSingleCwe(
            Policy.Operator policyOperator,
            Policy.ViolationState violationState,
            PolicyCondition.Operator conditionOperator,
            String inputConditionCwe,
            int inputCweId,
            int inputCweId2,
            boolean expectViolation,
            PolicyViolation.Type actualType,
            Policy.ViolationState actualViolationState)
            throws Exception {
        ...
        if (expectViolation) {
            ...
            assertThat(qm.getAllPolicyViolations(component)
                            ...
                            .getPolicyCondition()
                            .getSubject())
                    .isEqualTo(PolicyCondition.Subject.CWE);
            assertThat(qm.getAllPolicyViolations(component)
                            .get(0)
                            .getPolicyCondition()
                            .getViolationType())
            ...
            assertThat(qm.getAllPolicyViolations(component)
                            ...
                            .getPolicy()
                            .getViolationState())
                    .isEqualTo(actualViolationState);
        } else {
