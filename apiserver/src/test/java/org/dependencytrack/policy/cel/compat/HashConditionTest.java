...
public class HashConditionTest extends PersistenceCapableTest {
    ...
    private static Object[] parameters() {
        return new Object[] {
            new Object[] {
                Policy.Operator.ANY,
                Operator.IS,
                "{ \"algorithm\": \"SHA256\", \"value\": \"test_hash\" }",
                "test_hash",
                true,
                ViolationState.FAIL,
                Type.OPERATIONAL,
            ...
            new Object[] {
                Policy.Operator.ANY,
                Operator.IS,
                "{ \"algorithm\": \"test\", \"value\": \"test_hash\" }",
                "test_hash",
                false,
                ViolationState.INFO,
                null,
            ...
            new Object[] {
                Policy.Operator.ANY,
                Operator.IS,
                "{ \"algorithm\": null, \"value\": \"test_hash\" }",
                "test_hash",
                false,
                ViolationState.FAIL,
                null,
    ...
    public void testCondition(
            ...
            Type actualType,
            ViolationState actualViolationState)
            throws Exception {
