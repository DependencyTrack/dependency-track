...
/**
 * A message that is passed to a specific workflow run.
 *
 * @param recipientRunId ID of the receiving workflow run.
 * @param event          The {@link WorkflowEvent} carried by the message.
