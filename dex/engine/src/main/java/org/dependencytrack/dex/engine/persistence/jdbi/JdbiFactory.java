...
public final class JdbiFactory {
    ...
    public static Jdbi create(
            final DataSource dataSource, final Duration queryTimeout, final PageTokenEncoder pageTokenEncoder) {
        ...
        return Jdbi.create(dataSource)
                ...
                .configure(SqlStatements.class, cfg -> cfg.setQueryTimeout(Math.toIntExact(queryTimeout.toSeconds())))
                ...
                .registerColumnMapper(Payload.class, new ProtobufColumnMapper<>(Payload.parser()))
                .registerColumnMapper(RetryPolicy.class, new ProtobufColumnMapper<>(RetryPolicy.parser()))
                .registerColumnMapper(WorkflowEvent.class, new ProtobufColumnMapper<>(WorkflowEvent.parser()))
                .registerRowMapper(ActivityTaskId.class, new ActivityTaskIdRowMapper())
                .registerRowMapper(PolledActivityTask.class, new PolledActivityTaskRowMapper())
                .registerRowMapper(PolledWorkflowEvent.class, new PolledWorkflowEventRowMapper())
                .registerRowMapper(PolledWorkflowTask.class, new PolledWorkflowRunRowMapper())
                .registerRowMapper(TaskQueue.class, new TaskQueueRowMapper())
                .registerRowMapper(WorkflowRunHistoryEntry.class, new WorkflowRunHistoryEntryRowMapper())
                .registerRowMapper(WorkflowRunMetadata.class, new WorkflowRunMetadataRowMapper());
    }
}
