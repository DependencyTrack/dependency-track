...
Community input and contributions are explicitly requested. The chart repository can be found at
...
* Add support for localization based on browser language - [frontend/#805]
