    ...
    void shouldBackfillResolutionStatusFromExistingMetadata() throws Exception {
        ...
        try (final Connection connection = dataSource.getConnection();
                    ...
                    SELECT p."ID"
                     ...
                     CROSS JOIN (
                       VALUES ('resolved', 'pkg:maven/com.acme/resolved@1.0.0')
                            , ('resolved-stale', 'pkg:maven/com.acme/resolved@0.9.0')
            ...
            statement.execute("""
                    ...
                    VALUES ('pkg:maven/com.acme/resolved', '2.0.0', TIMESTAMPTZ '2026-03-03T00:00:00Z')
                         , ('pkg:maven/com.acme/notfound', NULL, TIMESTAMPTZ '2026-03-03T00:00:00Z')
                    """);
            ...
            statement.execute("""
                    ...
                    VALUES ('pkg:maven/com.acme/resolved@1.0.0', 'pkg:maven/com.acme/resolved', TIMESTAMPTZ '2026-01-01T00:00:00Z')
                         , ('pkg:maven/com.acme/resolved@0.9.0', 'pkg:maven/com.acme/resolved', TIMESTAMPTZ '2025-06-06T00:00:00Z')
        ...
        assertThat(rowByPurl.get("pkg:maven/com.acme/resolved@0.9.0"))
                .isEqualTo(new ResolutionRow("RESOLVED", Instant.parse("2025-06-06T00:00:00Z")));
