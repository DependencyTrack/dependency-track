...
class GithubPackageMetadataResolverFactoryTest extends AbstractExtensionFactoryTest<PackageMetadataResolver, GithubPackageMetadataResolverFactory> {

    protected GithubPackageMetadataResolverFactoryTest() {
        super(GithubPackageMetadataResolverFactory.class);
    }

    @ParameterizedTest
    @CsvSource(nullValues = "", value = {
            "pkg:github/foo@1.0, ",
            "pkg:github/ns/foo@1.0, pkg:github/ns/foo@1.0",
            "pkg:npm/foo@1.0, ",
            "pkg:github/foo, ",
            "pkg:github/ns/foo@1.0?key=value#sub/path, pkg:github/ns/foo@1.0",
    })
