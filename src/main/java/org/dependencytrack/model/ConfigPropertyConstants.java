...
public enum ConfigPropertyConstants {
    ...
    VULNERABILITY_ID_USE_CUSTOM("vulnerability-id", "use.custom.id", "true", PropertyType.BOOLEAN, "Use custom sequential ID generator; when false, uses OWASP default random INT- format"),
    ...
    TEXT_PLACEHOLDER_ENABLED("text-placeholder", "enabled", "true", PropertyType.BOOLEAN, "Flag to enable/disable custom text placeholders"),
    ...
    VULNERABILITY_SOURCE_OPTIONS("customization", "vulnerability-source.options", "{\"enabled\":true,\"values\":[{\"key\":\"CUSTOMER\",\"label\":\"Customer\"},{\"key\":\"PEN_TEST\",\"label\":\"Pen-Test\"},{\"key\":\"SONARQUBE\",\"label\":\"SonarQube\"},{\"key\":\"INTERNAL_RESEARCH\",\"label\":\"Internal Research\"},{\"key\":\"VENDOR_ADVISORY\",\"label\":\"Vendor Advisory\"},{\"key\":\"OTHER\",\"label\":\"Other\"}]}", PropertyType.STRING, "Admin-configurable vulnerability source of discovery dropdown options JSON");
