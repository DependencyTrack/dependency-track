...
public enum ConfigPropertyConstants {
    ...
    DEFECTDOJO_USERNAME("integrations", "defectdojo.username", null, PropertyType.STRING, "The username to authenticate to DefectDojo with"),
    DEFECTDOJO_PASSWORD("integrations", "defectdojo.password", null, PropertyType.ENCRYPTEDSTRING, "The password to use when authenticating to DefectDojo"),
