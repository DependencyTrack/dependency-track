...
public enum ConfigPropertyConstants {
    ...
    CUSTOM_RISK_SCORE_MEDIUM("risk-score", "riskscore.medium", "3", PropertyType.INTEGER, "Medium severity vulnerability weight (between 1-10)"),
    CUSTOM_RISK_SCORE_LOW("risk-score", "riskscore.low", "1", PropertyType.INTEGER, "Low severity vulnerability weight (between 1-10)"),
    CUSTOM_RISK_SCORE_UNASSIGNED("risk-score", "riskscore.unassigned", "5", PropertyType.INTEGER, "Unassigned severity vulnerability weight (between 1-10)");
