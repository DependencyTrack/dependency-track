...
public enum ConfigPropertyConstants {
    ...
    VULNERABILITY_SOURCE_NVD_FEEDS_URL("vuln-source", "nvd.cve.feeds.url", "https://nvd.nist.gov/feeds", PropertyType.URL, "A base URL pointing to the hostname and path of the NVD feeds"),
