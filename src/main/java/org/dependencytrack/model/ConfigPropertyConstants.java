...
public enum ConfigPropertyConstants {
    ...
    VULNERABILITY_SOURCE_NVD_ENABLED("vuln-source", "nvd.enabled", /* TODO: Re-enable before merge! */ "false", PropertyType.BOOLEAN, "Flag to enable/disable National Vulnerability Database"),
    ...
    VULNERABILITY_SOURCE_GOOGLE_OSV_ENABLED("vuln-source", "google.osv.enabled", /* TODO: Set to null again before merge! */ "Alpine;Debian;Ubuntu", PropertyType.STRING, "List of enabled ecosystems to mirror OSV"),
