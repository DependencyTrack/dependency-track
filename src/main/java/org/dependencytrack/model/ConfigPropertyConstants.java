...
public enum ConfigPropertyConstants {
    ...
    TEXT_PLACEHOLDER_ENABLED("text-placeholder", "enabled", "false", PropertyType.BOOLEAN, "Flag to enable/disable custom text placeholders on create and audit forms"),
    TEXT_PLACEHOLDER_CREATE_DESCRIPTION("text-placeholder", "create.description.placeholder", "1. What is the vulnerability?\n2. Which component or system is affected?\n3. What behaviour or condition makes this exploitable?", PropertyType.STRING, "Placeholder text for the description field on the create vulnerability form"),
    TEXT_PLACEHOLDER_CREATE_DETAIL("text-placeholder", "create.detail.placeholder", "<Add additional details>", PropertyType.STRING, "Placeholder text for the detail field on the create vulnerability form"),
    TEXT_PLACEHOLDER_CREATE_RECOMMENDATION("text-placeholder", "create.recommendation.placeholder", "1. What patch, update, or fix is available?\n2. Are there compensating controls if a fix is not available?\n3. What is the recommended timeline for remediation?", PropertyType.STRING, "Placeholder text for the recommendation field on the create vulnerability form"),
    TEXT_PLACEHOLDER_CREATE_REFERENCES("text-placeholder", "create.references.placeholder", "<Add any references if available, for example CPE / CVE references>", PropertyType.STRING, "Placeholder text for the references field on the create vulnerability form"),
    TEXT_PLACEHOLDER_AUDIT_COMMENT("text-placeholder", "audit.comment.placeholder", "<Add all participants for the review/assessment>", PropertyType.STRING, "Placeholder text for the comment field on the audit form"),
    TEXT_PLACEHOLDER_AUDIT_DETAILS_INSTRUCTION("text-placeholder", "audit.details.instruction", "1. Affected Software: Identify which software items or components are impacted.\n2. Security Context: Consider the intended environment of use and any defense-in-depth measures in place.\n3. Risk Assessment: Assess the risk in accordance with your organization's risk management process.\n4. Root Cause: Determine the root cause and whether it applies to other products.\n5. Related Issues: Check for related security issues in the same product.\n6. Follow-up: Define any required follow-up actions, such as vendor disclosure or customer communication.", PropertyType.STRING, "Instruction text shown above the analysis details field on the audit form");
