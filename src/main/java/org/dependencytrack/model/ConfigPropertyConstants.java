...
public enum ConfigPropertyConstants {
    ...
    VULNERABILITY_ID_USE_CUSTOM("vulnerability-id", "use.custom.id", "false", PropertyType.BOOLEAN, "Use custom sequential ID generator; when false, uses OWASP default random INT- format"),
    ...
    TEXT_PLACEHOLDER_ENABLED("text-placeholder", "enabled", "false", PropertyType.BOOLEAN, "Flag to enable/disable custom text placeholders"),
    TEXT_PLACEHOLDER_CREATE_DESCRIPTION("text-placeholder", "create.description.placeholder", SystemUtils.getEnvironmentVariable("TEXT_PLACEHOLDER_CREATE_DESCRIPTION_DEFAULT", "Customize this text to assist your team, consistent with your organisation's processes and terminology. e.g.\n1. What is the vulnerability?\n2. Which component or system is affected?\n3. What behaviour or condition makes this exploitable?"), PropertyType.STRING, "Default placeholder text for create vulnerability description"),
    ...
    TEXT_PLACEHOLDER_CREATE_RECOMMENDATION("text-placeholder", "create.recommendation.placeholder", SystemUtils.getEnvironmentVariable("TEXT_PLACEHOLDER_CREATE_RECOMMENDATION_DEFAULT", "Customize this text to assist your team, consistent with your organisation's processes and terminology. e.g.\n1. What patch, update, or fix is available?\n2. Are there compensating controls if a fix is not available?\n3. What is the recommended timeline for remediation?"), PropertyType.STRING, "Default placeholder text for create vulnerability recommendation"),
