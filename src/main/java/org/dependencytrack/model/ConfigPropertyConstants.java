...
public enum ConfigPropertyConstants {
    ...
    SCANNER_REMOVE_MISMATCHED("scanner", "remove.mismatched", "false", PropertyType.BOOLEAN, "Flag to enable/disable removing vulnerabilities from components that do not match versions range"),
