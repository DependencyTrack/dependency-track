...
public enum DefaultNotificationPublishers {
    ...
    JIRA("Atlassian JIRA", "Publishes a notification as a new JIRA issue", JiraPublisher.class, "/templates/notification/publisher/jira.peb", MediaType.APPLICATION_JSON, true);
