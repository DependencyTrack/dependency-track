...
public class DefaultObjectGenerator implements ServletContextListener {
    ...
    private void loadDefaultRepositories() {
        try (QueryManager qm = new QueryManager()) {
            ...
            qm.createRepository(RepositoryType.GEM, "rubygems.org", "https://rubygems.org/", true, false, null, null);
            qm.createRepository(RepositoryType.HEX, "hex.pm", "https://hex.pm/", true, false, null, null);
            qm.createRepository(RepositoryType.MAVEN, "central", "https://repo1.maven.org/maven2/", true, false, null, null);
            qm.createRepository(RepositoryType.MAVEN, "atlassian-public", "https://maven.atlassian.com/content/repositories/atlassian-public/", true, false, null, null);
            qm.createRepository(RepositoryType.MAVEN, "jboss-releases", "https://repository.jboss.org/nexus/content/repositories/releases/", true, false, null, null);
            qm.createRepository(RepositoryType.MAVEN, "clojars", "https://repo.clojars.org/", true, false, null, null);
            qm.createRepository(RepositoryType.MAVEN, "google-android", "https://maven.google.com/", true, false, null, null);
            qm.createRepository(RepositoryType.NPM, "npm-public-registry", "https://registry.npmjs.org/", true, false, null, null);
            qm.createRepository(RepositoryType.PYPI, "pypi.org", "https://pypi.org/", true, false, null, null);
            qm.createRepository(RepositoryType.NUGET, "nuget-gallery", "https://api.nuget.org/", true, false, null, null);
            qm.createRepository(RepositoryType.COMPOSER, "packagist", "https://repo.packagist.org/", true, false, null, null);
            qm.createRepository(RepositoryType.CARGO, "crates.io", "https://crates.io", true, false, null, null);
            qm.createRepository(RepositoryType.GO_MODULES, "proxy.golang.org", "https://proxy.golang.org", true, false, null, null);
        }
    }
