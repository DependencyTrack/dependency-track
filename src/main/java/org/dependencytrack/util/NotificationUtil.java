...
public final class NotificationUtil {
    ...
    public static String generateVulnerabilityScheduledNotificationContent(final List<Vulnerability> vulnerabilities, final List<Project> projects, final ZonedDateTime lastExecutionTime) {
        final String content;
    ...
    public static String generatePolicyScheduledNotificationContent(final List<PolicyViolation> policyViolations, final List<Project> projects, final ZonedDateTime lastExecutionTime) {
        final String content;
