...
public final class NotificationUtil {
    ...
    public static JsonObject toJson(final Vulnerability vulnerability) {
        ...
        JsonUtil.add(vulnerabilityBuilder, "owaspLikelihood", vulnerability.getOwaspLikelihoodScore());
        JsonUtil.add(vulnerabilityBuilder, "owaspTechnicalImpact", vulnerability.getOwaspTechnicalImpactScore());
        JsonUtil.add(vulnerabilityBuilder, "owaspBusinessImpact", vulnerability.getOwaspBusinessImpactScore());
