...
<script type="text/javascript" src="<c:url value="/assets/bootstrap-daterangepicker/moment.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="/assets/bootstrap-daterangepicker/daterangepicker.min.js"/>"></script>
