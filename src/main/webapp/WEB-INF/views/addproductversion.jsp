...
<h2>Add new version to existing application</h2>
<a href="logout">logout</a>
<div class="content">
<form:form method="post" action="${pageContext.request.contextPath}/addproductversion/${appid}">

	<table>
	<tr>
		<td><label>Application Name</label>
			<input name="name" type="text" value ="${name}" readonly="readonly"/> </td>
