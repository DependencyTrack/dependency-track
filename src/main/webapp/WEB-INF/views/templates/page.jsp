...
<div class="navbar navbar-static-top">
    <div class="navbar-inner">
        <ul class="nav">
            <li class="<c:if test="${param.content!='applications'}">in</c:if>active"><a href="<c:url value="${pageContext.request.contextPath}/applications"/>"><spring:message code="label.applications"/></a></li>
            <li class="<c:if test="${param.content!='libraries'}">in</c:if>active"><a href="<c:url value="${pageContext.request.contextPath}/libraries"/>"><spring:message code="label.libraries"/></a></li>
            <li class="<c:if test="${param.content!='about'}">in</c:if>active"><a href="<c:url value="${pageContext.request.contextPath}/about"/>"><spring:message code="label.about"/></a></li>
        </ul>
    </div>
</div>
