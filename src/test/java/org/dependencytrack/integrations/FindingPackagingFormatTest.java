...
class FindingPackagingFormatTest extends PersistenceCapableTest {
    ...
    void testFindingsVulnerabilityAndAliases() {
        ...
        Finding findingWithoutAlias = new Finding(project.getUuid(), "component-uuid-1", "component-name-1", "component-group",
                ...
                "vuln-subtitle", "vuln-description", "vuln-recommendation", Severity.CRITICAL, BigDecimal.valueOf(7.2), "vector2", BigDecimal.valueOf(8.4), "vector3", BigDecimal.valueOf(1.25), BigDecimal.valueOf(1.75), BigDecimal.valueOf(1.3),
                BigDecimal.valueOf(0.5), BigDecimal.valueOf(0.9), "787", "references", new Date(), AnalyzerIdentity.OSSINDEX_ANALYZER, new Date(), null, null, AnalysisState.NOT_AFFECTED, true);
        ...
        Finding findingWithAlias = new Finding(project.getUuid(), "component-uuid-2", "component-name-2", "component-group",
                ...
                "vuln-subtitle", "vuln-description", "vuln-recommendation", Severity.HIGH, BigDecimal.valueOf(7.2), "vector2", BigDecimal.valueOf(8.4), "vector3", BigDecimal.valueOf(1.25), BigDecimal.valueOf(1.75), BigDecimal.valueOf(1.3),
                BigDecimal.valueOf(0.5), BigDecimal.valueOf(0.9), "787", "references", new Date(), AnalyzerIdentity.INTERNAL_ANALYZER, new Date(), null, null, AnalysisState.NOT_AFFECTED, true);
