...
class FortifySscClientTest {
    ...
    @Test
    void testOneTimeTokenPositiveCase(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
    ...
    @Test
    void testOneTimeTokenInvalidCredentials(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
        WireMock.stubFor(WireMock.post(WireMock.urlPathEqualTo("/ssc/api/v1/fileTokens"))
    ...
    @Test
    void testUploadFindingsPositiveCase(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
    ...
    @Test
    void testUploadFindingsNegativeCase(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
        String token = "db975c97-98b1-4988-8d6a-9c3e044dfff3";
