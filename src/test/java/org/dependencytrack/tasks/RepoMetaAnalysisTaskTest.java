...
class RepoMetaAnalysisTaskTest extends PersistenceCapableTest {
    ...
    @Test
    void informTestNullPassword(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
    ...
    @Test
    void informTestNullUserName(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
        WireMock.stubFor(WireMock.get(WireMock.anyUrl()).withHeader("Authorization", containing("Basic"))
                .willReturn(WireMock.aResponse()
                        .withStatus(200)
                        .withResponseBody(Body.ofBinaryOrText("""
    ...
    @Test
    void informTestNullUserNameAndPassword(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
    ...
    @Test
    void informTestUserNameAndPassword(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
        WireMock.stubFor(WireMock.get(WireMock.anyUrl())
                .willReturn(WireMock.aResponse()
                        .withStatus(200)
                        .withResponseBody(Body.ofBinaryOrText("""
