...
class TelemetrySubmissionTaskTest extends PersistenceCapableTest {
    ...
    @Test
    void shouldSubmitTelemetryDataWhenEnabled(WireMockRuntimeInfo wmRuntimeInfo) {
    ...
    @Test
    void shouldNotSubmitTelemetryDataWhenDisabled(WireMockRuntimeInfo wmRuntimeInfo) {
        qm.createConfigProperty(
                TELEMETRY_SUBMISSION_ENABLED.getGroupName(),
                TELEMETRY_SUBMISSION_ENABLED.getPropertyName(),
                "false",
    ...
    @Test
    void shouldNotSubmitTelemetryDataWhenLastSubmittedWithinOneDay(WireMockRuntimeInfo wmRuntimeInfo) {
        qm.createConfigProperty(
                TELEMETRY_SUBMISSION_ENABLED.getGroupName(),
                TELEMETRY_SUBMISSION_ENABLED.getPropertyName(),
                "true",
    ...
    @Test
    void shouldFollowRedirect(WireMockRuntimeInfo wmRuntimeInfo) {
        qm.createConfigProperty(
                TELEMETRY_SUBMISSION_ENABLED.getGroupName(),
                TELEMETRY_SUBMISSION_ENABLED.getPropertyName(),
                "true",
    ...
    @Test
    void shouldNotRecordSubmittedTelemetryDataWhenRateLimited(WireMockRuntimeInfo wmRuntimeInfo) {
        qm.createConfigProperty(
                TELEMETRY_SUBMISSION_ENABLED.getGroupName(),
                TELEMETRY_SUBMISSION_ENABLED.getPropertyName(),
                "true",
