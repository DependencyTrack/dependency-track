    ...
    class MatchesTest {
        ...
        void shouldMatchOnMajorVersionAcrossMinor() throws Exception {
            final OsDistribution distroA =
                    OsDistribution.of(new PackageURL("pkg:rpm/redhat/sudo@1.9.5?distro=rhel-8.6"));
        ...
        void shouldMatchRhelAndRedhatPrefixForSameMajor() throws Exception {
            ...
            final OsDistribution distroB =
                    OsDistribution.of(new PackageURL("pkg:rpm/redhat/sudo@1.9.5?distro=redhat-9.7"));
        ...
        void shouldMatchComponentWithRhelPrefixAgainstCpe() throws Exception {
            final OsDistribution component =
                    OsDistribution.of(new PackageURL("pkg:rpm/redhat/libsolv@0.7.24-3.el8?distro=rhel-8"));
        ...
        void shouldNotMatchComponentAgainstCpeOfDifferentMajor() throws Exception {
            final OsDistribution component =
                    OsDistribution.of(new PackageURL("pkg:rpm/redhat/libsolv@0.7.24-3.el9?distro=redhat-9.7"));
