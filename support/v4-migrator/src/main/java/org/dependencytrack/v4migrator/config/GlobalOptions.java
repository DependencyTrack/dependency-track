...
public final class GlobalOptions {
    ...
    @Option(names = "--target-url", description = "JDBC URL of the v5 target PostgreSQL.", required = true)
    ...
    @Option(names = "--dry-run", description = "Run preflight and print a plan; do not mutate any database.")
    public boolean dryRun;

    @Option(
            names = "--socket-timeout",
